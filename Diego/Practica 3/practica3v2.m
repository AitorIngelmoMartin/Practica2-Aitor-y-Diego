...
Lad_up_dB   =  Lgases_up_dB + Lnubes_up_dB;
Lad_down_dB = Lgases_down_dB + Lnubes_down_dB;
...
BW_senal = (1+roll_off)*(Rb*FEC/(log2(M)));

BW_ruido = Rb*FEC/log2(M); %ancho de banda de ruido de la portadora

C_I0 = C_I + 10*log10(BW_ruido); % C_NO_IM (de intermodulacion)
...
PIRE_et_dBW = SFD_dBW + 10*log10(4*pi*d_tx^2) + Lad_up_dB + Margen;
