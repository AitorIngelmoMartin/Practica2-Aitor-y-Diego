...
% coseno alzado con un factor de roll-off de 0,3. El terreno presente entre las estaciones es un terreno seco (sigma=0,001 S/m y epsilon_R=15) y un 
% factor de rugosidad del terreno gamma=0,2. Se utilizan antenas con polarización horizontal poco directivas de 9dB de ganancia. Las alturas de las
% antenas con respecto al nivel del mar son 210m, en un extremo, y 54m, en el otro extremo. Los terminales de ambas estaciones presentan 2dB de 
% pérdidas. Los terminales de la estación receptora conectan con un LNA con una figura de ruido de 6dB y ganancia 20dB, un mezclador con pérdidas 12dB y un amplificador en frecuencia intermedia con figura de ruido de 14dB. Este último amplificador cuenta con un control automático de potencia que permite amplificar hasta 20dB. El requisito de Eb/N0 es de 16dB para un filtro ideal. El MTTR es de 4 horas y el MTBF de 468.000 horas. Datos: R0,01=33mm/h
...
Prec_total_dBm = CNR_dB + 10*log10(K*T_tot*Bn) + 30;
