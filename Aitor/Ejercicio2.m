...
subvano_inferior         = e(posicion_obstaculo_mayor-1);
subvano_superior         = e(posicion_obstaculo_mayor+1);
...
for iteracion=1:numero_iteraciones(2)    
    ...
    uve_iterado(iteracion,:)           = (2.58e-3)*despejamiento_iterado(iteracion,:)./R1;
