...
C_N0_total_dB = Eb_N0_dB + 10*log10(Rb_portadora);

C_N0_down = PIRE_sat_dBW - Lbf_down_dB - Lad_down_dB + G_T_est - 10*log10(Boltzman);

L = C_N0_total_dB - C_N0_down
...
PIRE_et_dBW = C_N0_up + Lbf_up_dB + Lad_up_dB - G_T_sat + 10*log10(Boltzman)